...
# Form implementation generated from reading ui file 'c:\Users\dursun\Documents\PythonCodes\FriendRequest.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(380, 75)
        Form.setMaximumSize(QtCore.QSize(390, 75))
        self.groupBox_2 = QtWidgets.QGroupBox(Form)
        self.groupBox_2.setGeometry(QtCore.QRect(0, 0, 371, 71))
        ...
        self.groupBox_2.setMaximumSize(QtCore.QSize(390, 71))
        ...
        self.groupBox_4.setStyleSheet("QGroupBox{background-color:#f3f6fb;border-radius:10px;}\n"
"QLabel{color:#4f596f;}")
        ...
        self.callingLabel.setMinimumSize(QtCore.QSize(0, 47))
        font = QtGui.QFont()
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/sources/indir__1_-removebg-preview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/sources/4676082-removebg-preview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.callingLabel.setText(_translate("Form", "AFA"))
import sources_rc
